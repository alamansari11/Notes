...
vector<int> LeaderInArrayBrute(vector<int> v) {
    vector<int> ans;
...
vector<int> LeaderInArrayOptimal(vector<int> v) {
    vector<int> ans;
...
void solve() {
    ...
    auto brute = LeaderInArrayBrute(v);
    debug(brute);
    // auto stl = nextPermuteStl(v);
    // debug(stl);
    auto optimal = LeaderInArrayOptimal(v);
    debug(optimal);
